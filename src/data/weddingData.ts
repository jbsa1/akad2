...
export const weddingData: WeddingData = {
  ...
  story: {
    ...
    // 
    newJourney:
      "We got engaged in June 2025, surrounded by our family.Now, with grateful hearts, we are ready to begin the next chapter— no more distance, just one home, one journey, one love. we're very excited to counting down our Big Day in March. It's getting real. A new milestone, towards our forever.",
  },
  photos: [
    "/img1.jpeg",
    "/img2.jpeg",
